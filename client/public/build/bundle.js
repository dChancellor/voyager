...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			p = element("p");
    			p.textContent = "or search for existing slugs";
    			t5 = space();
    			create_component(textfield.$$.fragment);
    			t6 = space();
    			...
    			attr_dev(h1, "class", "svelte-7tfqx5");
    			add_location(h1, file, 49, 4, 1418);
    			attr_dev(button0, "class", "login svelte-7tfqx5");
    			add_location(button0, file, 50, 4, 1453);
    			attr_dev(p, "class", "search-label svelte-7tfqx5");
    			add_location(p, file, 52, 6, 1595);
    			attr_dev(div, "class", "search-container svelte-7tfqx5");
    			add_location(div, file, 51, 4, 1558);
    			attr_dev(button1, "class", "submit svelte-7tfqx5");
    			add_location(button1, file, 75, 4, 2227);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "helper-alert svelte-7tfqx5");
    			add_location(div, file, 64, 8, 1953);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(64:6) {#if isHelperVisible}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "loader svelte-7tfqx5");
    			add_location(div, file, 77, 6, 2329);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (80:4) {#if !retrievingData && slugs[0].slug != ''}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "results svelte-7tfqx5");
    			add_location(a, file, 82, 8, 2515);
    			attr_dev(div, "class", "slugs-container svelte-7tfqx5");
    			add_location(div, file, 80, 6, 2417);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(80:4) {#if !retrievingData && slugs[0].slug != ''}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "error svelte-7tfqx5");
    			add_location(p, file, 87, 6, 2716);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
